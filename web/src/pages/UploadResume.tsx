  ...
  return (
    <div className="min-h-screen bg-black p-8">
      <div className="container mx-auto max-w-5xl">
        <h1 className="text-5xl font-bold text-white mb-4">Upload Resume</h1>
        <p className="text-xl text-gray-400 mb-8">Upload your base resume to start tailoring for specific jobs</p>
      ...
      {parsedResume && (
        <div className="glass rounded-3xl p-8">
          ...
          {parsedResume.parsed_data.experience && parsedResume.parsed_data.experience.length > 0 && (
            <div className="mb-6">
              <h3 className="text-xl font-bold text-white mb-3">Professional Experience</h3>
