...
export default function ParsedResumeValidator({
  ...
  return (
    <div className="glass rounded-2xl border border-white/10 p-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        <CheckCircle className="w-6 h-6 text-green-400" />
        <div>
          <h2 className="text-xl font-semibold text-white">Resume Parsed Successfully</h2>
          <p className="text-sm text-gray-400">Review the extracted data and fix any issues.</p>
        </div>
      </div>
                ...
                <div className="flex gap-2">
                  {key === 'summary' ? (
                    <textarea
                      ...
                      rows={3}
                      className="flex-1 bg-white/5 border border-white/20 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500"
                    />
                  ) : (
                    <input
                      type="text"
