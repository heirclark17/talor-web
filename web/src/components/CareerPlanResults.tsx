...
const Tooltip = ({ term, definition, children }: { term: string; definition: string; children: React.ReactNode }) => {
  ...
  return (
    <span className="relative inline-block">
      ...
      {show && (
        <span className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-theme text-theme text-xs rounded-lg shadow-lg whitespace-nowrap max-w-xs">
...
const cardColors = {
  ...
  sources: { iconBg: 'bg-gray-500/20', iconText: 'text-theme-secondary', linkText: 'text-theme-secondary' },
}
    ...
    <div className="space-y-4 break-words">
      ...
      <div className="glass rounded-xl border-2 border-blue-500/30 overflow-hidden bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10">
        <div className="px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-theme">Quick Start</h2>
            <p className="text-sm text-theme-secondary">Your 3 most important next steps</p>
          </div>
        ...
        <div className="p-6 grid md:grid-cols-3 gap-4">
          ...
          {quickStart.primaryRole && (
            <button
              ...
              className="bg-theme-glass-5 hover:bg-theme-glass-10 border border-theme-subtle rounded-lg p-4 text-left transition-all hover:border-blue-500/50 group"
            >
              ...
              <h3 className="text-theme font-semibold mb-1 group-hover:text-blue-300 transition-colors">
              ...
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-theme-tertiary group-hover:text-blue-400 transition-colors" />
              </div>
            </button>
          )}
          ...
          {quickStart.firstWeekTask && (
            <button
              ...
              className="bg-theme-glass-5 hover:bg-theme-glass-10 border border-theme-subtle rounded-lg p-4 text-left transition-all hover:border-orange-500/50 group"
            >
              <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-theme font-semibold mb-1 group-hover:text-orange-300 transition-colors">
              ...
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-theme-tertiary group-hover:text-orange-400 transition-colors" />
              </div>
            </button>
          )}
          ...
          {quickStart.topCert && (
            <button
              ...
              className="bg-theme-glass-5 hover:bg-theme-glass-10 border border-theme-subtle rounded-lg p-4 text-left transition-all hover:border-yellow-500/50 group"
            >
              <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-theme font-semibold mb-1 group-hover:text-yellow-300 transition-colors line-clamp-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-theme-tertiary group-hover:text-yellow-400 transition-colors" />
              </div>
            </button>
          )}
        </div>
      ...
      <div className="glass rounded-lg border border-theme-subtle p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          <div className="bg-pink-500/10 border border-pink-500/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-theme-secondary">Events</div>
          </div>
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-green-400">{stats.skillsHave}</div>
            <div className="text-xs text-theme-secondary">Skills You Have</div>
          </div>
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-orange-400">{stats.weeksInPlan}</div>
            <div className="text-xs text-theme-secondary">Week Plan</div>
          </div>
        </div>
        {/* Salary indicator */}
        <div className="mt-3 flex items-center justify-center gap-2 py-2 bg-gradient-to-r from-green-500/10 via-emerald-500/10 to-teal-500/10 rounded-lg border border-green-500/20">
          ...
          <span className="text-sm text-theme-secondary">Target Salary Range:</span>
        ...
        <div className="glass rounded-lg border border-theme-subtle p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-theme font-semibold">12-Week Journey</h3>
            </div>
            <button
              onClick={() => openModal('timeline')}
            ...
            <div className="flex justify-between mt-2">
              {plan.timeline.twelveWeekPlan.slice(0, 6).map((week, idx) => (
                <div key={idx} className="flex flex-col items-center">
                  <div className={`w-3 h-3 rounded-full ${idx === 0 ? 'bg-orange-500 ring-2 ring-orange-500/30' : 'bg-theme-glass-20'} mb-1`} />
                  <span className="text-xs text-theme-tertiary">W{week.weekNumber}</span>
                </div>
              ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        {plan.targetRoles && plan.targetRoles.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Target Roles</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{plan.targetRoles.length} roles identified</p>
        ...
        {plan.skillsAnalysis && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Skills Analysis</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{stats.skillsHave} skills you have, {stats.skillsToLearn} to build</p>
        ...
        {plan.skillsGuidance && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Skills Guidance</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{skillsGuidanceCount} skills with development plans</p>
        ...
        {plan.certificationPath && plan.certificationPath.length > 0 && (
          ...
          >
            ...
            <p className="text-theme-secondary text-sm line-clamp-2">{stats.certsCount} recommended certifications</p>
        ...
        {plan.experiencePlan && plan.experiencePlan.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Experience Plan</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{stats.projectsCount} hands-on projects</p>
        ...
        {plan.events && plan.events.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Networking Events</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{stats.eventsCount} events & conferences</p>
        ...
        {plan.timeline && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Action Timeline</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{stats.weeksInPlan}-week plan with milestones</p>
        ...
        {plan.resumeAssets && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Resume & LinkedIn</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">Headlines, summaries, bullets & ATS keywords</p>
        ...
        {plan.educationOptions && plan.educationOptions.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Education Options</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{plan.educationOptions.length} training options</p>
        ...
        {plan.researchSources && plan.researchSources.length > 0 && (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-theme">Research Sources</h3>
            </div>
            <p className="text-theme-secondary text-sm line-clamp-2">{plan.researchSources.length} citations</p>
      ...
      <div className="glass rounded-lg border border-theme-subtle p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-theme font-semibold mb-1">Export Your Plan</h3>
            <p className="text-sm text-theme-secondary">Download this career plan for offline access</p>
          </div>
          <button
            onClick={onExportPDF || (() => window.print())}
            className="flex items-center gap-2 px-4 py-2 bg-theme-glass-10 hover:bg-theme-glass-20 rounded-lg text-theme transition-colors"
          >
      ...
      {activeModal && (
        ...
        >
          ...
          {/* Modal Content */}
          <div
            className="relative w-full max-w-4xl max-h-[90vh] h-full sm:h-auto overflow-y-auto bg-theme sm:rounded-3xl border-0 sm:border border-theme-subtle shadow-2xl"
            ...
            <div className="p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  {plan.targetRoles.map((role, idx) => (
                    <div key={idx} className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-lg font-semibold text-theme mb-2">{role.title}</h3>
                      <p className="text-theme-secondary mb-4">{role.whyAligned}</p>
                      <div className="grid md:grid-cols-2 gap-4 text-sm mb-4">
                        <div>
                          <span className="text-theme-tertiary">Growth Outlook:</span>
                          <p className="text-theme mt-1">{role.growthOutlook}</p>
                        </div>
                        <div>
                          <span className="text-theme-tertiary">Salary Range:</span>
                          <p className="text-theme mt-1">{role.salaryRange}</p>
                        </div>
                      </div>

                      {role.typicalRequirements && role.typicalRequirements.length > 0 && (
                        <div className="mb-4">
                          <span className="text-theme-tertiary text-sm">Typical Requirements:</span>
                          <ul className="mt-2 space-y-1">
                            {role.typicalRequirements.map((req, reqIdx) => (
                              <li key={reqIdx} className="text-theme text-sm flex items-start gap-2">
                      ...
                      {role.bridgeRoles && role.bridgeRoles.length > 0 && (
                        <div className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                          ...
                          <div className="space-y-3">
                            {role.bridgeRoles.map((bridge, bridgeIdx) => (
                              <div key={bridgeIdx} className="bg-theme-glass-5 rounded p-3">
                                <div className="font-semibold text-theme mb-1">{bridge.title}</div>
                                <div className="text-sm text-theme-secondary mb-2">{bridge.whyGoodFit}</div>
                                <div className="text-xs text-theme-tertiary">Time to qualify: {bridge.timeToQualify}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {plan.skillsAnalysis.alreadyHave.map((skill, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            <div className="font-semibold text-theme mb-2">{skill.skillName}</div>
                            <div className="text-sm text-theme-secondary mb-2">
                              <span className="text-theme-tertiary">How you have this:</span> {skill.evidenceFromInput}
                            </div>
                            <div className="text-sm text-theme-secondary mb-3">
                              <span className="text-theme-tertiary">Maps to target role:</span> {skill.targetRoleMapping}
                            </div>
                            {skill.resumeBullets && skill.resumeBullets.length > 0 && (
                              <div className="bg-theme-glass-5 rounded p-3">
                                <div className="text-xs text-theme-tertiary mb-2">Resume bullets:</div>
                                {skill.resumeBullets.map((bullet, bIdx) => (
                                  <div key={bIdx} className="text-sm text-theme-secondary mb-1">• {bullet}</div>
                                ))}
                              </div>
                            )}
                          </div>
                          ...
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            ...
                            <div className="grid md:grid-cols-2 gap-3 mb-3">
                              <div className="text-sm">
                                <span className="text-theme-tertiary">Current context:</span>
                                <p className="text-theme-secondary mt-1">{skill.currentContext}</p>
                              </div>
                              <div className="text-sm">
                                <span className="text-theme-tertiary">Target context:</span>
                                <p className="text-theme-secondary mt-1">{skill.targetContext}</p>
                              </div>
                            </div>
                            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded p-3 mb-3">
                              ...
                              <div className="text-sm text-theme-secondary">{skill.howToReframe}</div>
                            </div>
                            {skill.resumeBullets && skill.resumeBullets.length > 0 && (
                              <div className="bg-theme-glass-5 rounded p-3">
                                <div className="text-xs text-theme-tertiary mb-2">Reframed resume bullets:</div>
                                {skill.resumeBullets.map((bullet, bIdx) => (
                                  <div key={bIdx} className="text-sm text-theme-secondary mb-1">• {bullet}</div>
                                ))}
                              </div>
                        ...
                        {plan.skillsAnalysis.needToBuild.map((skill, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            <div className="flex items-start justify-between mb-2">
                              <div className="font-semibold text-theme">{skill.skillName}</div>
                            ...
                            <div className="text-sm text-theme-secondary mb-3">
                              <span className="text-theme-tertiary">Why needed:</span> {skill.whyNeeded}
                            </div>
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3 mb-2">
                              ...
                              <div className="text-sm text-theme-secondary">{skill.howToBuild}</div>
                            </div>
              ...
              {activeModal === 'skillsGuidance' && plan.skillsGuidance && (
                <div className="space-y-6">
                  ...
                  {plan.skillsGuidance.skillDevelopmentStrategy && (
                    <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-theme-subtle rounded-lg p-6">
                      <h3 className="text-theme font-semibold mb-3 flex items-center gap-2">
                        <Zap className="w-5 h-5" />
                        Your Skills Development Strategy
                      </h3>
                      <p className="text-theme-secondary leading-relaxed">{plan.skillsGuidance.skillDevelopmentStrategy}</p>
                    </div>
                  )}
                  ...
                  {plan.skillsGuidance.softSkills && plan.skillsGuidance.softSkills.length > 0 && (
                    <div>
                      <h3 className="text-theme font-semibold mb-4 flex items-center gap-2">
                      ...
                      <div className="space-y-4">
                        {plan.skillsGuidance.softSkills.map((skill, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-5 border border-theme-subtle">
                            <div className="flex items-start justify-between mb-3">
                              <h4 className="text-lg font-semibold text-theme">{skill.skillName}</h4>
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-theme-secondary bg-theme-glass-10 px-3 py-1 rounded-full">
                                  <Clock className="w-3 h-3 inline mr-1" />
                                  {skill.estimatedTime}
                                </span>
                              </div>
                            ...
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-4">
                              ...
                              <p className="text-sm text-theme-secondary">{skill.whyNeeded}</p>
                            </div>
                            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 mb-4">
                              <h5 className="text-green-300 font-semibold text-sm mb-2">How to Develop This Skill</h5>
                              <p className="text-sm text-theme-secondary">{skill.howToImprove}</p>
                            </div>
                            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 mb-4">
                              <h5 className="text-purple-300 font-semibold text-sm mb-2">Real-World Application</h5>
                              <p className="text-sm text-theme-secondary">{skill.realWorldApplication}</p>
                            </div>
                            {skill.resources && skill.resources.length > 0 && (
                              <div>
                                <h5 className="text-theme font-semibold text-sm mb-2">Learning Resources</h5>
                                <div className="space-y-1">
                        ...
                        <div className="px-6 pb-6 space-y-6">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {project.skillsDemonstrated.map((skill, sIdx) => (
                                  <span key={sIdx} className="bg-theme-glass-10 px-3 py-1 rounded-full text-sm text-theme">
                                    {skill}
                                  </span>
                                ))}
                              </div>
                            ...
                            <div>
                              ...
                              <div className="space-y-3">
                                {project.detailedTechStack.map((tech, tIdx) => (
                                  <div key={tIdx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                                    <div className="flex items-start justify-between mb-2">
                                      <div>
                                        <h5 className="text-theme font-semibold">{tech.name}</h5>
                                        <div className="text-xs text-theme-secondary uppercase">{tech.category}</div>
                                      </div>
                                    </div>
                                    <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3 mb-3">
                                      ...
                                      <div className="text-sm text-theme-secondary">{tech.whyThisTech}</div>
                                    </div>
                                    {tech.learningResources && tech.learningResources.length > 0 && (
                                      <div>
                                        <div className="text-xs text-theme-tertiary mb-2">Learning resources:</div>
                                        <div className="space-y-1">
                                          {tech.learningResources.map((url, uIdx) => (
                                            <a
                                              ...
                                              target="_blank"
                                              rel="noopener noreferrer"
                                              className="text-xs text-theme-muted hover:text-theme underline flex items-center gap-1"
                                            >
                          ...
                          {project.architectureOverview && (
                            <div className="bg-theme-glass-5 rounded-lg p-4">
                              ...
                              <p className="text-sm text-theme-secondary">{project.architectureOverview}</p>
                            </div>
                          )}
                          ...
                          {project.githubExampleRepos && project.githubExampleRepos.length > 0 && (
                            <div>
                              <h5 className="text-theme font-semibold text-sm mb-2">Similar Projects on GitHub</h5>
                              <div className="flex flex-wrap gap-2">
                                {project.githubExampleRepos.map((repo, rIdx) => (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-1 text-xs text-theme-muted hover:text-theme underline"
                                  >
                                    <ExternalLink className="w-3 h-3" />
                                    Example {rIdx + 1}
                                  </a>
                  ...
                  {plan.events.map((event, idx) => (
                    <div key={idx} className="bg-theme-glass-5 rounded-lg border border-theme-subtle overflow-hidden">
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2 flex-wrap">
                            <h3 className="text-lg font-semibold text-theme">{event.name}</h3>
                            <span className="text-xs bg-theme-glass-10 px-2 py-1 rounded text-theme uppercase">{event.type}</span>
                            <span className="text-xs bg-theme-glass-10 px-2 py-1 rounded text-theme uppercase">{event.scope}</span>
                        ...
                        <ChevronDown className={`w-5 h-5 text-theme-secondary transition-transform ml-4 flex-shrink-0 mt-1 ${expandedEvent === idx ? 'rotate-180' : ''}`} />
                      </button>
                        ...
                        <div className="px-6 pb-6 space-y-4">
                          ...
                          {event.targetAudience && (
                            <div className="bg-theme-glass-5 rounded-lg p-3">
                              <div className="text-xs text-theme-tertiary mb-1">Target Audience:</div>
                              <div className="text-sm text-theme">{event.targetAudience}</div>
                            </div>
                          )}
                          ...
                          {event.whyAttend && (
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                              ...
                              <p className="text-sm text-theme-secondary">{event.whyAttend}</p>
                            </div>
                          )}
                          ...
                          {event.keyTopics && event.keyTopics.length > 0 && (
                            <div>
                              <h4 className="text-theme font-semibold text-sm mb-2">Key Topics Covered</h4>
                              <div className="flex flex-wrap gap-2">
                                {event.keyTopics.map((topic, tIdx) => (
                                  <span key={tIdx} className="bg-theme-glass-10 px-3 py-1 rounded-full text-xs text-theme">
                                    {topic}
                                  </span>
                                ))}
                              </div>
                          ...
                          {event.notableSpeakers && event.notableSpeakers.length > 0 && (
                            <div>
                              <h4 className="text-theme font-semibold text-sm mb-2">Notable Speakers/Companies</h4>
                              <div className="grid grid-cols-2 gap-2">
                                {event.notableSpeakers.map((speaker, sIdx) => (
                                  <div key={sIdx} className="text-sm text-theme-secondary flex items-center gap-2">
              ...
              {activeModal === 'timeline' && plan.timeline && (
                <div className="space-y-6">
                  ...
                  {plan.timeline.twelveWeekPlan && plan.timeline.twelveWeekPlan.length > 0 && (
                    <div>
                      <h3 className="text-theme font-semibold mb-4">12-Week Tactical Plan</h3>
                      <div className="space-y-3">
                        {plan.timeline.twelveWeekPlan.map((week, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            <div className="flex items-center gap-3 mb-2">
                              <div className="w-8 h-8 bg-theme-glass-10 rounded-full flex items-center justify-center text-theme text-sm font-semibold">
                                {week.weekNumber}
                              </div>
                              <div className="text-theme font-semibold">{week.milestone || `Week ${week.weekNumber}`}</div>
                            </div>
                            {week.tasks && week.tasks.length > 0 && (
                              <ul className="space-y-1 ml-11">
                                {week.tasks.map((task, taskIdx) => (
                                  <li key={taskIdx} className="text-theme-secondary text-sm flex items-start gap-2">
                                    <Check className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                                    {task}
                                  </li>
                                ))}
                  ...
                  {plan.timeline.sixMonthPlan && plan.timeline.sixMonthPlan.length > 0 && (
                    <div>
                      <h3 className="text-theme font-semibold mb-4">6-Month Strategic Phases</h3>
                      <div className="space-y-3">
                        {plan.timeline.sixMonthPlan.map((month, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            <div className="flex items-center gap-3 mb-3">
                              <div className="w-10 h-10 bg-theme-glass-10 rounded-lg flex items-center justify-center text-theme font-semibold">
                                M{month.monthNumber}
                              </div>
                              <div>
                                <div className="text-theme font-semibold">{month.phaseName}</div>
                                <div className="text-xs text-theme-secondary">Month {month.monthNumber}</div>
                              </div>
                            </div>
                            <div className="space-y-3 ml-13">
                              {month.goals && month.goals.length > 0 && (
                                <div>
                                  <div className="text-sm text-theme-tertiary mb-1">Goals:</div>
                                  <ul className="space-y-1">
                                    {month.goals.map((goal, gIdx) => (
                                      <li key={gIdx} className="text-theme-secondary text-sm flex items-start gap-2">
                              ...
                              {month.deliverables && month.deliverables.length > 0 && (
                                <div>
                                  <div className="text-sm text-theme-tertiary mb-1">Deliverables:</div>
                                  <ul className="space-y-1">
                                    {month.deliverables.map((deliverable, dIdx) => (
                                      <li key={dIdx} className="text-theme-secondary text-sm flex items-start gap-2">
                                        <Check className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                                        {deliverable}
                                      </li>
                                    ))}
                  ...
                  {plan.timeline.applyReadyCheckpoint && (
                    <div className="bg-green-500/20 border-2 border-green-500/50 rounded-lg p-6 text-center">
                      ...
                      <p className="text-theme">{plan.timeline.applyReadyCheckpoint}</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {activeModal === 'resume' && plan.resumeAssets && (
                <div className="space-y-6">
                  ...
                  {plan.resumeAssets.headline && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Professional Headline</h3>
                      <div className="bg-theme-glass-10 rounded-lg p-4 mb-4">
                        <p className="text-theme text-lg font-semibold">{plan.resumeAssets.headline}</p>
                      </div>
                      {plan.resumeAssets.headlineExplanation && (
                        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                          <h4 className="text-blue-300 font-semibold text-sm mb-2">Why This Headline Works</h4>
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.headlineExplanation}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {plan.resumeAssets.summary && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Professional Summary</h3>
                      <div className="bg-theme-glass-10 rounded-lg p-4 mb-4">
                        <p className="text-theme leading-relaxed">{plan.resumeAssets.summary}</p>
                      </div>
                      ...
                      {plan.resumeAssets.summaryBreakdown && (
                        <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 mb-3">
                          ...
                          <p className="text-sm text-theme-secondary whitespace-pre-line">{plan.resumeAssets.summaryBreakdown}</p>
                        </div>
                      )}
                      ...
                      {plan.resumeAssets.summaryStrategy && (
                        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                          ...
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.summaryStrategy}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {plan.resumeAssets.skillsGrouped && plan.resumeAssets.skillsGrouped.length > 0 && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Skills Section (Organized by Category)</h3>
                      <div className="space-y-4">
                        {plan.resumeAssets.skillsGrouped.map((group, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg p-4 border border-theme-subtle">
                            <div className="flex items-center justify-between mb-3">
                              <h4 className="text-theme font-semibold">{group.category}</h4>
                              <span className={`text-xs px-2 py-1 rounded ${
                            ...
                            <div className="text-xs text-theme-secondary bg-theme-glass-5 rounded p-2">
                      ...
                      {plan.resumeAssets.skillsOrderingRationale && (
                        <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
                          ...
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.skillsOrderingRationale}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {plan.resumeAssets.targetRoleBullets && plan.resumeAssets.targetRoleBullets.length > 0 && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Achievement Bullets for Resume</h3>
                      <div className="space-y-3">
                        {plan.resumeAssets.targetRoleBullets.map((bullet, idx) => (
                          <div key={idx} className="bg-theme-glass-5 rounded-lg border border-theme-subtle overflow-hidden">
                            ...
                            <button
                              ...
                              className="w-full p-4 hover:bg-theme-glass-5 transition-colors text-left"
                            >
                              <div className="flex items-start justify-between">
                                <p className="text-theme-secondary text-sm flex-1 pr-4">{bullet.bulletText}</p>
                                <ChevronDown className={`w-5 h-5 text-theme-secondary transition-transform flex-shrink-0 ${expandedBullet === idx ? 'rotate-180' : ''}`} />
                              </div>
                            </button>
                              ...
                              <div className="px-4 pb-4 space-y-3 pt-3">
                                {bullet.whyThisWorks && (
                                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
                                    ...
                                    <p className="text-xs text-theme-secondary">{bullet.whyThisWorks}</p>
                                  </div>
                                )}
                                {bullet.whatToEmphasize && (
                                  <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3">
                                    <h5 className="text-purple-300 font-semibold text-sm mb-1">Interview Talking Points</h5>
                                    <p className="text-xs text-theme-secondary">{bullet.whatToEmphasize}</p>
                                  </div>
                                )}
                                {bullet.keywordsIncluded && bullet.keywordsIncluded.length > 0 && (
                                  <div>
                                    <div className="text-xs text-theme-tertiary mb-2">ATS Keywords Included:</div>
                                ...
                                {bullet.structureExplanation && (
                                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                                    ...
                                    <p className="text-xs text-theme-secondary">{bullet.structureExplanation}</p>
                                  </div>
                                )}
                              </div>
                            )}
                      ...
                      {plan.resumeAssets.bulletsOverallStrategy && (
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 mt-4">
                          ...
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.bulletsOverallStrategy}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {plan.resumeAssets.howToReframeCurrentRole && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">How to Reframe Your Current Experience</h3>
                      <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4 mb-4">
                        <p className="text-sm text-theme-secondary whitespace-pre-line">{plan.resumeAssets.howToReframeCurrentRole}</p>
                      </div>

                      {plan.resumeAssets.experienceGapsToAddress && plan.resumeAssets.experienceGapsToAddress.length > 0 && (
                        <div>
                          <h4 className="text-theme font-semibold text-sm mb-2">Addressing Experience Gaps</h4>
                          <ul className="space-y-1">
                  ...
                  {plan.resumeAssets.keywordsForAts && plan.resumeAssets.keywordsForAts.length > 0 && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Keywords for <Tooltip term="ATS" definition={jargonDefinitions['ATS']}>ATS</Tooltip> (Applicant Tracking Systems)</h3>
                      ...
                      {plan.resumeAssets.keywordPlacementStrategy && (
                        <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                          ...
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.keywordPlacementStrategy}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                    ...
                    {plan.resumeAssets.linkedinHeadline && (
                      <div className="mb-4">
                        <h4 className="text-theme font-semibold text-sm mb-2">LinkedIn Headline</h4>
                        <div className="bg-theme-glass-10 rounded-lg p-3">
                          <p className="text-theme">{plan.resumeAssets.linkedinHeadline}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {plan.resumeAssets.linkedinAboutSection && (
                      <div className="mb-4">
                        <h4 className="text-theme font-semibold text-sm mb-2">LinkedIn About Section</h4>
                        <div className="bg-theme-glass-10 rounded-lg p-3 max-h-60 overflow-y-auto">
                          <p className="text-theme-secondary text-sm whitespace-pre-line">{plan.resumeAssets.linkedinAboutSection}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {plan.resumeAssets.linkedinStrategy && (
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                        ...
                        <p className="text-sm text-theme-secondary">{plan.resumeAssets.linkedinStrategy}</p>
                      </div>
                    )}
                  </div>
                  ...
                  {plan.resumeAssets.coverLetterTemplate && (
                    <div className="bg-theme-glass-5 rounded-lg p-6 border border-theme-subtle">
                      <h3 className="text-theme font-semibold mb-3">Cover Letter Framework</h3>
                      <div className="bg-theme-glass-10 rounded-lg p-4 mb-4 max-h-80 overflow-y-auto">
                        <p className="text-theme-secondary text-sm whitespace-pre-line">{plan.resumeAssets.coverLetterTemplate}</p>
                      </div>
                      ...
                      {plan.resumeAssets.coverLetterGuidance && (
                        <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                          ...
                          <p className="text-sm text-theme-secondary">{plan.resumeAssets.coverLetterGuidance}</p>
                        </div>
                      )}
                    </div>
                  )}
                          ...
                          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                            ...
                            <ul className="space-y-1">
                              {option.pros.map((pro, pIdx) => (
                                <li key={pIdx} className="text-sm text-theme-secondary flex items-start gap-2">
                                  <Check className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                                  {pro}
                                </li>
                              ))}
                  ...
                  <div className="grid md:grid-cols-2 gap-2">
                    {plan.researchSources.map((source, idx) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-theme-muted hover:text-theme underline flex items-center gap-1 truncate"
                      >
