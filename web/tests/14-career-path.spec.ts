...
test.describe('Phase 14: career path', () => {
  test.beforeEach(async ({ page }) => { await bypassAuth(page); await page.goto('/career-path'); });
  test('should load page', async ({ page }) => { await expect(page).toHaveURL(/\/career-path/); await expect(page.locator('body')).toBeVisible(); });
